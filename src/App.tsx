...
import { Menu, GraduationCap, University, Briefcase, Compass, UsersIcon } from 'lucide-react';
import ScrollAnimation from './animation/ScrollAnimation';
import { FaBriefcase, FaCalendarAlt, FaClock, FaComments, FaEnvelope, FaFileAlt, FaGlobeAsia, FaHome, FaMoneyBillWave, FaPassport, FaPhone, FaPlane, FaUniversity } from 'react-icons/fa';
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 mt-8">
        ...
        <div className="w-full md:w-4/5 mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            {/* Flex layout for left and right - no gap */}
            <div className="flex flex-col md:flex-row">
              
              {/* Left Side - 35% width (between 30-40%) */}
              <div className="md:w-[35%] bg-gradient-to-br from-[#FFF7F0] via-[#FFE5EF] to-[#E8F1FF]">
                <ScrollAnimation delay={300}>
                    ...
                    <div className="backdrop-blur-sm mt-">
                      <div className="grid grid-cols-1 gap-">
                        ...
                        {/* <div className="flex items-start space-x-3 p-2">
                          ...
                          <div className="min-w-0 flex-1">
                            <p className="font-medium text-xs text-gray-700">Mode</p>
                            <p className="text-gray-600 text-xs break-words">Online (Zoom)</p>
                          </div>
                        </div> */}
              ...
              {/* Right Side - 65% width (more width for form) */}
